...
if (!defined('XORTIFY_WGETSERIAL_API'))
	define('XORTIFY_WGETSERIAL_API', _RUN_XORTIFY_API_SERIAL);
include_once _RUN_XORTIFY_ROOT_PATH . '/class/auth/auth_wgetserialised_provisionning.php';
