 ...
 *
 */
class CacheModel extends CacheEngine
{
    /**
     * settings
    ...
    {
        $xoopsDB =& DatabaseFactory::getDatabaseConnection();

        parent::init($settings);
        $defaults = array('fields' => array('data' , 'expires'));
        $this->settings = array_merge($defaults, $this->settings);
        $this->fields = $this->settings['fields'];
        $this->model = new CacheModelHandler($xoopsDB);
        return true;
    }
 ...
 * @access public
 */
class CacheModelObject extends Object
{
    function CacheModelObject()
    {
        $this->__construct();
    }
 ...
 * @access public
 */
class CacheModelHandler extends PersistableObjectHandler
{
    const TABLE = 'cache_model';
    const CLASSNAME = 'CacheModelObject';
    const KEYNAME = 'key';
}
