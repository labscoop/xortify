<?php
	...
	<p align="center" style='font-size:1.34em; border:dashed; margin:10 10 10 10; background-color:#feedcd;'}><u>Spam Token's Left:</u>&nbsp;<?php echo (isset($_SESSION['xortify']['left'])?$_SESSION['xortify']['left']:'0'); ?></p>
