 ...
 * @file:			auth_curlxml_provisionning.php		
...
*/
class XortifyAuthRest_CurlxmlProvisionning {
	...
	function &getInstance(&$auth_instance)
	{
		...
		if (!isset($provis_instance)) {
			$provis_instance = new XortifyAuthRest_CurlxmlProvisionning($auth_instance);
		}
	 ...
	 */
	function XortifyAuthRest_CurlxmlProvisionning (&$auth_instance) {
