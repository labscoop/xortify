 ...
 * @file:			auth_wgetserialised_provisionning.php		
...
*/
class XortifyAuthRest_WgetserialisedProvisionning {
	...
	function &getInstance(&$auth_instance)
	{
		...
		if (!isset($provis_instance)) {
			$provis_instance = new XortifyAuthRest_WgetserialisedProvisionning($auth_instance);
		}
	 ...
	 */
	function XortifyAuthRest_WgetserialisedProvisionning (&$auth_instance) {
