 ...
 * @file:			auth_curlserialised_provisionning.php		
...
*/
class XortifyAuthRest_CurlserialisedProvisionning {
	...
	function &getInstance(&$auth_instance)
	{
		...
		if (!isset($provis_instance)) {
			$provis_instance = new XortifyAuthRest_CurlserialisedProvisionning($auth_instance);
		}
	 ...
	 */
	function XortifyAuthRest_CurlserialisedProvisionning (&$auth_instance) {
