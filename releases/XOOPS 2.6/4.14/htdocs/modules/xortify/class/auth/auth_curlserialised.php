...
if (!defined('XORTIFY_CURLSERIAL_API'))
	define('XORTIFY_CURLSERIAL_API', $GLOBALS['xoops']->getModuleConfig('xortify_uriserial', 'xortify'));
...
include_once XOOPS_ROOT_PATH . '/modules/xortify/class/auth/auth_curlserialised_provisionning.php';
