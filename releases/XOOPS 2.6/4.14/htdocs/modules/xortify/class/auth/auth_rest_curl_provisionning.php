 ...
 * @file:			auth_curl_provisionning.php		
...
*/
class XortifyAuthRest_CurlProvisionning {
	...
	function &getInstance(&$auth_instance)
	{
		...
		if (!isset($provis_instance)) {
			$provis_instance = new XortifyAuthRest_CurlProvisionning($auth_instance);
		}
	 ...
	 */
	function XortifyAuthRest_CurlProvisionning (&$auth_instance) {
