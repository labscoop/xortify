...
class REST_CURLSERIALISEDXortifyExchange {
	 ...
	 * Constructor
	 */
	function __construct($url = 'https://xortify.com')
	{
	...
	function REST_CURLSERIALISEDXortifyExchange ($url) {
		...
		curl_setopt($this->curl_client, CURLOPT_CONNECTTIMEOUT, $GLOBALS['xoops']->getModuleConfig('curl_connecttimeout', 'xortify'));
		curl_setopt($this->curl_client, CURLOPT_TIMEOUT, $GLOBALS['xoops']->getModuleConfig('curl_timeout', 'xortify'));
