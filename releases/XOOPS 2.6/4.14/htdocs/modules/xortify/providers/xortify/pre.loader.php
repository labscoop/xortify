 ...
 */
	...
	if (!$servers = XoopsCache::read('server_list_xortify')) {
		...
		if (!isset($poll['success'])||$poll['success']==false) {
			XoopsCache::write('server_list_xortify', array(0=>array('server'=>'http://xortify.com/unban/?op=unban', 'replace' => 'unban/?op=unban', 'search' => 'Solve Puzzel:'), 1=>array('server'=>'http://xortify.xoops.org/unban/?op=unban', 'replace' => 'unban/?op=unban', 'search' => 'Solve Puzzel:')), (integer)$GLOBALS['xoops']->getModuleConfig('server_cache', 'xortify'));
		}
	}	
?>