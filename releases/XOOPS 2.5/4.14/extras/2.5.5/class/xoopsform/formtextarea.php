...
class XoopsFormTextArea extends XoopsFormElement
{
    ...
    function render()
    {
        return "<input type='hidden' name='xortify_check[]' value='".$this->getName()."'/><textarea name='" . $this->getName() . "' id='" . $this->getName() . "'  title='" . $this->getTitle() . "' rows='" . $this->getRows() . "' cols='" . $this->getCols() . "'" . $this->getExtra() . ">" . $this->getValue() . "</textarea>";
    }
}
