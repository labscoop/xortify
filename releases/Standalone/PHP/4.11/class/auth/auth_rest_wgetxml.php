...
if (!defined('XORTIFY_REST_API'))
	define('XORTIFY_REST_API', _RUN_XORTIFY_API_REST.'%s/xml/?%s');
include_once _RUN_XORTIFY_ROOT_PATH . '/class/auth/auth_rest_wgetxml_provisionning.php';
