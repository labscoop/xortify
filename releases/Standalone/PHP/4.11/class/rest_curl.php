...
class REST_CURLXortifyExchange {
	...
	function REST_CURLXortifyExchange ($url) {
		...
		$this->curl_xoops_username = $_SESSION['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['xortify_username'];
		$this->curl_xoops_password = md5($_SESSION['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['xortify_password']);
