 ...
 */
	...
	$GLOBALS['xoops']->tpl->assign('pathImageIcon', $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['ImageIcon']);
	$GLOBALS['xoops']->tpl->assign('pathImageAdmin', $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['ImageAdmin']);
	...
	case "signup":	
		...
		case "save":	
			...
			if ($stop!='') {
				...
				if ($disclaimer != _XOR_ADMIN_NONETWORKCOMM_DISCLAIMER) {
					...
					$GLOBALS['xoops']->tpl->assign('protocol', $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['protocol']);
					switch($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['protocol']) {
						case 'curlserialised':
						case 'wgetserialised':
							$GLOBALS['xoops']->tpl->assign('port', $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['xortify_uriserial']);
							break;
						case 'curl':
						case 'json':
							$GLOBALS['xoops']->tpl->assign('port', $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['xortify_urijson']);
							break;
						case 'curlxml':
						case 'wgetxml':
							$GLOBALS['xoops']->tpl->assign('port', $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['xortify_urixml']);
							break;
						case 'soap':
							$GLOBALS['xoops']->tpl->assign('port', $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['xortify_urisoap']);
							break;
					}
		...
		case "signup":
			...
			$disclaimer = XortifyAuthFactory::getAuthConnection(false, $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['protocol'])->network_disclaimer();
	...
	case "list":
		...
		if (!$bans = XoopsCache::read('xortify_bans_cache')) {
			...
			XoopsCache::write('xortify_bans_cache', $bans, $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['xortify_seconds']);
			XoopsCache::write('xortify_bans_cache_backup', $bans, ($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['xortify_seconds'] * 1.45));					
		}
	...
	default:
		...
		if ($result = XoopsCache::read('xortify_cleanup_last')) {
			$indexAdmin->addInfoBoxLine(sprintf(_XOR_ADMIN_THEREARE_WHENCLEANED, date(_DATESTRING, $result['when'])), 'default' , 'Purple');
