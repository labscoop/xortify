...
class XortifyAuthMinimumCloudProvisionning {
	...
	function &getInstance(&$auth_instance)
	{
		...
		if (!isset($provis_instance)) {
			$provis_instance = new XortifyAuthMinimumCloudProvisionning($auth_instance);
		}
	 ...
	 */
	function XortifyAuthMinimumCloudProvisionning (&$auth_instance) {
