...
class XortifyCorePreload extends XoopsPreloadItem
{
	...
	function eventCoreIncludeCommonEnd($args)
	{
		...
		if (!isset($GLOBALS['xortify'])||!isset($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['module'])||!is_object($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['module']))
		...
		if ((isset($_COOKIE['xortify']['lid'])&&$_COOKIE['xortify']['lid']!=0)||(isset($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['lid'])&&$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['lid']!=0)&&!strpos($_SERVER["PHP_SELF"], '/banned.php')) {
	...
	function eventCoreFooterEnd($args)
	{
		...
		if ((isset($result['time'])?(float)$result['time']:0)<=microtime(true)) {
			XoopsCache::write('xortify_core_footer_end', array('time'=>microtime(true)+$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['fault_delay']), $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY][_MI_XOR_VERSION]['moduleConfig']['fault_delay']);
			if (XortifyCorePreload::hasAPIUserPass()) { 		
