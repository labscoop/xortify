 ...
 * @subpackage form
 */
class unbanFormSelectMember extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function unbanFormSelectMember($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		foreach($members as $member)
			$this->addOption($member->getVar('member_id'), $member->getVar('ipv4'));
