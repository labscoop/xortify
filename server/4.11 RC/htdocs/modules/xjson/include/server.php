...
if (!function_exists('json_encode')){
	...
	function json_encode($data) {
		static $json = NULL;
		if (!class_exists('Services_JSON')) include_once $GLOBALS['xoops']->path('/modules/xjson/include/JSON.php');
...
if (!function_exists('json_decode')){
	...
	/*	Dencodes a JSON Flat Data to an Array
	 *  json_encode($data)
	 *
	 *  @param string $data			String to be converted from JSON Data
	 *  @return array
	 */
