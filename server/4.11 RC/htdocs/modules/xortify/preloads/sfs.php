				...
				if (is_array($args[6])) {
					if (isset($args[6]['success']))
						if ($args[6]['success']==true)
							if (($args[6]['email']['frequency']>=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['email_freq']||$args[6]['username']['frequency']>=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['uname_freq']||$args[6]['ip']['frequency']>=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['ip_freq']) &&
								(strtotime($args[6]['email']['lastseen'])>time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['email_lastseen']||strtotime($args[6]['username']['lastseen'])>time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['uname_lastseen']||strtotime($args[6]['ip']['lastseen'])>time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['ip_lastseen'])) {
									
									XoopsCache::write('xortify_sfs_'.sha1($args[5]['uname'].$args[5]['email'].(isset($args[5]['ip4'])?$args[5]['ip4']:"").(isset($args[5]['ip6'])?$args[5]['ip6']:"").(isset($args[5]['proxy-ip4'])?$args[5]['proxy-ip4']:"").(isset($args[5]['proxy-ip4'])?$args[5]['proxy-ip6']:"").$args[5]['network-addy']), array_merge($args[6], array('ipdata' => $args[5])), $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_ip_cache']);					
									...
									$comments = array('comment' => _XOR_BAN_SFS_TYPE."\n".
																  _XOR_BAN_SFS_EMAIL_FREQ.': '.$args[6]['email']['frequency'].' >= '.$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['email_freq']. "\n".
																  _XOR_BAN_SFS_EMAIL_LASTSEEN.': '.date(_DATESTRING, strtotime($args[6]['email']['lastseen'])) . ' > ' . date(_DATESTRING, time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['email_lastseen']) . "\n" .
																  _XOR_BAN_SFS_USERNAME_FREQ.': '.$args[6]['username']['frequency'].' >= '.$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['uname_freq']. "\n".
																  _XOR_BAN_SFS_USERNAME_LASTSEEN.': '.date(_DATESTRING, strtotime($args[6]['username']['lastseen'])) . ' > ' . date(_DATESTRING, time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['uname_lastseen']) . "\n" .
																  _XOR_BAN_SFS_IP_FREQ.': '.$args[6]['ip']['frequency'].' >= '.$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['ip_freq']. "\n".
																  _XOR_BAN_SFS_IP_LASTSEEN.': '.date(_DATESTRING, strtotime($args[6]['ip']['lastseen'])) . ' > ' . date(_DATESTRING, time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['ip_lastseen']), 4, $args[5]);
									$error=array();
									...
									$log->setVar('extra', _XOR_BAN_SFS_TYPE."\n".
														  ...
														  _XOR_BAN_SFS_USERNAME_LASTSEEN.': '.date(_DATESTRING, strtotime($args[6]['username']['lastseen'])) . ' > ' . date(_DATESTRING, time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['uname_lastseen']) . "\n" .
														  _XOR_BAN_SFS_IP_FREQ.': '.$args[6]['ip']['frequency'].' >= '.$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['ip_freq']. "\n".
														  _XOR_BAN_SFS_IP_LASTSEEN.': '.date(_DATESTRING, strtotime($args[6]['ip']['lastseen'])) . ' > ' . date(_DATESTRING, time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['ip_lastseen']));
					...
					XoopsCache::write('xortify_sfs_provider_'.sha1($args[5]['uname'].$args[5]['email'].(isset($args[5]['ip4'])?$args[5]['ip4']:"").(isset($args[5]['ip6'])?$args[5]['ip6']:"").(isset($args[5]['proxy-ip4'])?$args[5]['proxy-ip4']:"").(isset($args[5]['proxy-ip4'])?$args[5]['proxy-ip6']:"").$args[5]['network-addy']), array_merge($args[6], array('ipdata' => $args[5])), $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_ip_cache']);
