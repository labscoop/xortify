			...
			{	
				if (is_array($args[6])) {
					if ($args[6]['success']==true)
						if (($args[6]['octeta']<=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octeta']&&$args[6]['octetb']>$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetb']&&$args[6]['octetc']>=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetc'])) {
						...
						XoopsCache::write('xortify_php_'.sha1($args[5]['uname'].$args[5]['email'].(isset($args[5]['ip4'])?$args[5]['ip4']:"").(isset($args[5]['ip6'])?$args[5]['ip6']:"").(isset($args[5]['proxy-ip4'])?$args[5]['proxy-ip4']:"").(isset($args[5]['proxy-ip4'])?$args[5]['proxy-ip6']:"").$args[5]['network-addy']), array_merge($args[6], array('ipdata' => $args[5])), $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_ip_cache']);
			
						xoops_loadLanguage('ban', 'xortify');

						$bans = array(0=>$args[5]['ipdata']);
						$comments = array('comment' => _XOR_BAN_PHP_TYPE."\n".
								_XOR_BAN_PHP_OCTETA.' '.$args[6]['octeta'].' <= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octeta']."\n".
								_XOR_BAN_PHP_OCTETB.' '.$args[6]['octetb'].' > ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetb']."\n".
								_XOR_BAN_PHP_OCTETC.' '.$args[6]['octetc'].' >= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetc']."\n", 5, $args[5]);
						$error=array();
						...
						$log->setVar('extra', _XOR_BAN_PHP_OCTETA.' '.$args[6]['octeta'].' <= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octeta']."\n".
								_XOR_BAN_PHP_OCTETB.' '.$args[6]['octetb'].' > ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetb']."\n".
								_XOR_BAN_PHP_OCTETC.' '.$args[6]['octetc'].' >= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetc']);
				...
				XoopsCache::write('xortify_php_provider_'.sha1($args[5]['uname'].$args[5]['email'].(isset($args[5]['ip4'])?$args[5]['ip4']:"").(isset($args[5]['ip6'])?$args[5]['ip6']:"").(isset($args[5]['proxy-ip4'])?$args[5]['proxy-ip4']:"").(isset($args[5]['proxy-ip4'])?$args[5]['proxy-ip6']:"").$args[5]['network-addy']), array_merge($args[6], array('ipdata' => $args[5])), $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_seconds']);
