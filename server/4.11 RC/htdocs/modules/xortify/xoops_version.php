...
$modversion['releasedate'] 	= "Friday: March 1, 2013";
...
$modversion['release_info'] = "Stable 2012/08/12";
$modversion['release_file'] = XOOPS_URL."/modules/xortify/docs/changelog.txt";
$modversion['release_date'] = "2012/08/12";
...
$modversion['config'][$i]['valuetype'] = 'array';
$modversion['config'][$i]['default'] = array(XOOPS_GROUP_USER);
...
$modversion['config'][$i]['formtype'] = 'group_multi';
$modversion['config'][$i]['valuetype'] = 'array';
$modversion['config'][$i]['default'] = array(XOOPS_GROUP_ADMIN);
