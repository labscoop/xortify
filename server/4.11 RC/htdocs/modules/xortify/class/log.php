...
class XortifyLogHandler extends XoopsPersistableObjectHandler
{
    ...
    function insert($object, $force = true) {
		...
		$criteria = new Criteria('`date`', time()-$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['logdrops'], '<=');
    	...
    	if ($run_plugin_action){
    		if ($object->runPrePlugin($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['save_'.$object->getVar('action')])==true)
