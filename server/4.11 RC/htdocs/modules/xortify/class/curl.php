...
if (!defined('XORTIFY_CURL_API'))
	define('XORTIFY_CURL_API', $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_uricurl']);
...
class CURLXortifyExchange {
	...
	function CURLXortifyExchange () {
		...
		$this->curl_xoops_username = $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_username'];
		$this->curl_xoops_password = md5($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_password']);
