...
*/
	...
	if (!$checked = XoopsCache::read('xortify_xrt_'.sha1($ipdata['uname'].$ipdata['email'].(isset($ipdata['ip4'])?$ipdata['ip4']:"").(isset($ipdata['ip6'])?$ipdata['ip6']:"").(isset($ipdata['proxy-ip4'])?$ipdata['proxy-ip4']:"").(isset($ipdata['proxy-ip4'])?$ipdata['proxy-ip6']:"").$ipdata['network-addy'])))
	{
		...
		XoopsCache::write('xortify_xrt_'.sha1($ipdata['uname'].$ipdata['email'].(isset($ipdata['ip4'])?$ipdata['ip4']:"").(isset($ipdata['ip6'])?$ipdata['ip6']:"").(isset($ipdata['proxy-ip4'])?$ipdata['proxy-ip4']:"").(isset($ipdata['proxy-ip4'])?$ipdata['proxy-ip6']:"").$ipdata['network-addy']), array_merge($checked, array('ipdata' => $ipdata)), $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_ip_cache']);
	}
			...
			if (is_array($_REQUEST[$field])) {
				foreach ($_REQUEST[$field] as $id => $data) {
					...
					if ($result['spam']==true) {
						...
						if (isset($_COOKIE['xortify']['spams']))
							$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams'] = $_COOKIE['xortify']['spams'];
						$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams'] = $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams'] + 1;
						unset($_COOKIE['xortify']['spams']);
						setcookie('xortify', array_merge($_COOKIE['xortify'],array('spams' => $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams'])), time()+3600*24*7*4*3);
					
						xoops_loadLanguage('ban', 'xortify');
					
						if ($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams']>=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['spams_allowed']) {
				...
				if ($result['spam']==true) {
					...
					if (isset($_COOKIE['xortify']['spams']))
						$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams'] = $_COOKIE['xortify']['spams'];
					$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams'] = $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams'] + 1;
					setcookie('xortify', array('spams' => $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['spams']), time()+3600*24*7*4*3);
