 ...
 */
	...
	if (isset($GLOBALS['xoDoSoap']))
	{
		...
		if (is_array($result)) {
			...
			XoopsCache::write('xortify_bans_cache', $result, $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_seconds']);
			XoopsCache::write('xortify_bans_cache_backup', $result, ($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_seconds'] * 1.45));			
		}		
	}
