 ...
 */
	...
	if (!$ipdata = XoopsCache::read('xortify_php_'.sha1($_SERVER['REMOTE_ADDR'].(isset($_SERVER['HTTP_X_FORWARDED_FOR'])?$_SERVER['HTTP_X_FORWARDED_FOR']:'').$uid.$uname.$email))) {
		...
		XoopsCache::write('xortify_php_'.sha1($_SERVER['REMOTE_ADDR'].(isset($_SERVER['HTTP_X_FORWARDED_FOR'])?$_SERVER['HTTP_X_FORWARDED_FOR']:'').$uid.$uname.$email), $ipdata, $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_ip_cache']);
	}
	...
	if (!is_array($checked))
	{
		...
		if (is_array($result)) {
			if ($result['success']==true)
				if (($result['octeta']<=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octeta']&&$result['octetb']>$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetb']&&$result['octetc']>=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetc'])) {
					$module_handler =& xoops_gethandler('module');
					$config_handler =& xoops_gethandler('config');
					if (!is_object($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['module'])) $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['module'] = $module_handler->getByDirname('xortify');
					$configs = $config_handler->getConfigList($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['module']->mid());
					
					XoopsCache::write('xortify_php_'.sha1($ipdata['uname'].$ipdata['email'].(isset($ipdata['ip4'])?$ipdata['ip4']:"").(isset($ipdata['ip6'])?$ipdata['ip6']:"").(isset($ipdata['proxy-ip4'])?$ipdata['proxy-ip4']:"").(isset($ipdata['proxy-ip4'])?$ipdata['proxy-ip6']:"").$ipdata['network-addy']), array_merge($result, array('ipdata' => $ipdata)), $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['xortify_ip_cache']);					
				
					xoops_loadLanguage('ban', 'xortify');
					
					$result = $apiExchange->sendBan(_XOR_BAN_PHP_TYPE."\n".
												  _XOR_BAN_PHP_OCTETA.' '.$result['octeta'].' <= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octeta']."\n".
												  _XOR_BAN_PHP_OCTETB.' '.$result['octetb'].' > ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetb']."\n".
												  _XOR_BAN_PHP_OCTETC.' '.$result['octetc'].' >= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetc']."\n", 5, $ipdata);
					...
					$log->setVar('extra', _XOR_BAN_PHP_OCTETA.' '.$result['octeta'].' <= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octeta']."\n".
										  _XOR_BAN_PHP_OCTETB.' '.$result['octetb'].' > ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetb']."\n".
										  _XOR_BAN_PHP_OCTETC.' '.$result['octetc'].' >= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetc']);
		...
		if ($checked['success']==true) {
			if (($checked['octeta']<=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octeta']&&$checked['octetb']>$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetb']&&$checked['octetc']>=$GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetc'])) {
				...
				$log->setVar('extra', _XOR_BAN_PHP_OCTETA.' '.$checked['octeta'].' <= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octeta']."\n".
									  _XOR_BAN_PHP_OCTETB.' '.$checked['octetb'].' > ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetb']."\n".
									  _XOR_BAN_PHP_OCTETC.' '.$checked['octetc'].' >= ' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['octetc']);
