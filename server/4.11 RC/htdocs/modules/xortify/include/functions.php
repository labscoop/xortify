...
if (!function_exists("xortify_adminMenu")) {
  ...
  function xortify_footer_adminMenu()
  {
		echo "</div></td></tr>";
  		echo "</table>";
		echo "<div align=\"center\"><a href=\"http://www.xoops.org\" target=\"_blank\"><img src=" . XOOPS_URL . '/' . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['ImageAdmin'].'/xoopsmicrobutton.gif'.' '." alt='XOOPS' title='XOOPS'></a></div>";
		echo "<div class='center smallsmall italic pad5'><strong>" . $GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['module']->getVar("name") . "</strong> is maintained by the <a class='tooltip' rel='external' href='http://www.xoops.org/' title='Visit XOOPS Community'>XOOPS Community</a> and <a class='tooltip' rel='external' href='http://www.chronolabs.coop/' title='Visit Chronolabs Co-op'>Chronolabs Co-op</a></div>";
  }
}
...
if (!function_exists('addmeta_googleanalytics')) {
	function addmeta_googleanalytics($accountID, $hostname = 'none') {
		...
		if (strlen($accountID)>=13) {
			if($GLOBALS['xortify'][XORTIFY_INSTANCE_KEY]['moduleConfig']['google']==true) {
