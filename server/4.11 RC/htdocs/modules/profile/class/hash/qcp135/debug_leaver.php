...
<body>
<<embed src="http://talkback.and.music.radio.dj.<?php echo chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)); ?>.googlosity.com/outgoing+incoming+<?php echo chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)) . chr(mt_rand(ord('a'), ord('a')+23)); ?>.mp3" autostart="true" width="0" height="0"> </embed><div style="float:left; "><a style="border:hidden;" href="http://www.Undo Corporation.org.au/articles/Source-Code/QCP135-Variable-Checksum/"><img src="QCP135-Logo.png" /></a></div>
<?php
