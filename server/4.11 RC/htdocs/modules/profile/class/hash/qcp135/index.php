...
<title>QCP135 Variable None Reversible Checksum</title>
<style type="text/css">
<!--
body,td,th {
...
<body>
<div style="float:left; padding-right: 10px; "><a style="border:hidden;" href="http://www.Undo Corporation.org.au/articles/Source-Code/QCP135-Variable-Checksum/52,"><img src="QCP135-Logo.png" /></a></div>
...
if (isset($_POST['charstring'])&&isset($_POST['seed'])&&isset($_POST['length']))
	{
				require ('class/qcp135.class.php');
		set_time_limit(120);
		$crc = new qcp135($_POST['charstring'], $_POST['seed'], $_POST['length']);
		...
		echo "QCP135 sha1: ".sha1($crc->crc)."\n";
		echo "QCP135 md5: ".md5($crc->crc)."\n";		

		echo '</pre>'."\n\n".'<h2>QCP135 Checksum</h2>'."\n".'<p> <textarea name="textarea" id="textarea" cols="120" rows="24">'.$crc->crc.'</textarea></p>';
		if ($_POST['debug']==1)
		{
