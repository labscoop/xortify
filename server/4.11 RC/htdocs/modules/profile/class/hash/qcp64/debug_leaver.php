<?php
// $Id: debug_leaver.php 1.6.4 2008-08-15 13:40:00 (final) wishcraft $
//  ------------------------------------------------------------------------ //
...
<title>QCP64 Leaver Debug</title>
<style type="text/css">
<!--
body,td,th {
...
<?php 
	if (isset($_POST['charstring'])&&isset($_POST['seed'])&&isset($_POST['length']))
	{
		...
		require ('class/qcp64.leaver.php');
		
		$qcp64_base = new qcp64_base((int)$_POST['seed']);
		$enumerator = new qcp64_enumerator($qcp64_base);
		...
		$crc = new qcp64_leaver($enum_calc, $qcp64_base, $_POST['length']);
