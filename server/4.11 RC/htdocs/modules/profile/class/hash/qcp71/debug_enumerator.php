<?php
// $Id: debug_enumerator.php 1.1.0 - QCP71 2008-08-15 9:22:20 wishcraft $
//  ------------------------------------------------------------------------ //
...
<title>QCP71 Enumerator Debug Test</title>
<style type="text/css">
<!--
body,td,th {
...
<?php 
	if (isset($_POST['charstring'])&&isset($_POST['seed'])&&isset($_POST['length']))
	{
		...
		require ('class/qcp71.base.php');
		require ('class/qcp71.enumerator.php');
		
		$qcp71_base = new qcp71_base((int)$_POST['seed']);
		$enumerator = new qcp71_enumerator($qcp71_base, $_POST['length']);
