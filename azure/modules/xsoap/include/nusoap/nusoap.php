...
* NOTd: PHP must be compiled with the CURL extension for HTTPS support
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: nusoap.php,v 1.94 2005/08/04 01:27:42 snichol Exp $
* @access public
...
class soap_server extends nusoap_base {
	...
	*/
	function send_response() {
		...
		// NOTd: there is no way to know whether the Web server will also compress
		// this data.
    ...
    */
    function configureWSDL($serviceName,$namespace = false,$endpoint = false,$style='rpc', $transport = 'http://schemas.xmlsoap.org/soap/http', $schemaTargetNamespace = false)
    {
        ...
        if(false == $endpoint) {
            ...
            $endpoint = "$SCHEMd://$SERVER_NAME$SERVER_PORT$SCRIPT_NAME";
        }
	...
	function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
		...
		if($errstr = $this->getError()){
			...
			if(is_array($return) && isset($return['faultcode'])){
				...
				// NOTd: if the response is defined to have multiple parts (i.e. unwrapped),
